            ...
            <table class="bordered-table" style="top: 30%;margin-left: 27%">
                <tr>
                    ...
                    <td>
                        <table>
                            <tr>
                            <p style="margin-right: 10%;font-size: 15px;">Enter address: </p>
                            <input type="text" style="margin-left: 30%;width: 300px;height: 40px" class="form-control"  placeholder="Address">
                            </tr>
                            <tr>
                            <p style="margin-right: -30%;font-size: 15px;">Enter tax dentification number: </p>
                            <input type="text" style="margin-left: 30%;width: 300px;height: 40px" class="form-control"  placeholder="Tax dentification number">
                            </tr>
                            <tr>
                            ...
                            <tr>
                            <p style="margin-right: 0%;font-size: 15px;">Enter current job: </p>
                            <input type="text" style="margin-left: 30%;width: 300px;height: 40px" class="form-control"  placeholder="Current job">
                            </tr>
                        </table>                                    
                    </td>
                </tr>
